...
<head>
    ...
    <link rel="stylesheet" href="./../../../View/modules/Pais/style_form.css">
</head>
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="/pais"> Listar Países <span class="sr-only">(current)</span></a>
                </li>
...
<div class="container">
    <form action="/pais/save" method="post">
        <fieldset>
